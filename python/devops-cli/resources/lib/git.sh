...
# Azure DevOps has non-uniform URLs compared to the 3 main Git repos so here are first-flask conversion rules used by git_remotes_add_public_repos.sh / git_remotes_set_multi_origin.sh
git_to_azure_url(){
    local url="$1"
